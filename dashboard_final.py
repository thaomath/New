...
########################
data_test_std = pd.read_csv('C:\\Users\\LEMuon\\Downloads\\P7\\P7_data_test_20features_importance_std.csv', sep=",")
...
model_LGBM = pickle.load(open('C:\\Users\\LEMuon\\Downloads\\model_complete.pkl','rb'))
